...
import { ArrowUpCircle, CheckCircle2, Circle, HelpCircle, LucideProps } from "lucide-react";
...
export function StatusxDemo() {
  const [open, setOpen] = useState(false);
  const [value, setValue] = useState("");

  const getIconClassName = (icon: ForwardRefExoticComponent<Omit<LucideProps, "ref"> & RefAttributes<SVGSVGElement>> | IconType) => {
    switch (icon) {
